    ...
    <header className="bg-white border-b border-gray-200 h-14 px-4 flex items-center justify-between">
      <div className="flex items-center">
        <Link href="/" className="flex items-center">
          <div className="h-6 w-6 rounded bg-primary-500 flex items-center justify-center text-white font-medium text-xs mr-2">
            C
          </div>
          <span className="text-base font-bold text-gray-800">competeHQ</span>
        </Link>
      </div>
